  ...
  var body: some View {
    HStack {
      ...
      ZStack {
        ...
        Button(action: {
          print("Controle visibilidade apertado")
...
struct MostRecentlyPlacedButton: View {
  @EnvironmentObject var placamentSettings: PlacementSettings

  var body: some View {
    Button(action: {
      print("itens mais recente")
      self.placamentSettings.selectedModel = self.placamentSettings.recentlyPlaced.last
    }) {
      if let mostRecentlyPlacedModel = self.placamentSettings.recentlyPlaced.last {
